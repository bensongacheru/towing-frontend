...
import { FaHome, FaCar, FaUserAlt, FaHistory, FaRegClock, FaMapMarkerAlt, FaArrowLeft } from 'react-icons/fa';
...
const UserDashboard = () => {
  ...
  const [userProfile, setUserProfile] = useState({
    car: {
      ...
      expiry: '12/12/2024', // Mock insurance expiry
    },
    contact: {
      name: 'John Doe',
    ...
    <div className="flex min-h-screen bg-gray-800">
      <div className="w-1/4 bg-gray-900 text-white p-6 space-y-6">
        ...
        <ul className="space-y-4">
          {[
            { name: 'Home', icon: <FaHome />, section: 'profile', onClick: handleHomeClick },
